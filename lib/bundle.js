	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function mapCenter() {
	      return this.lvlMap.mazeNodes[14][0].spritePos()[1];
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnackMan = function (_MovingObject) {
	  ...
	  function SnackMan(game) {
	    ...
	    _this.color = '#000000';
	    _this.pos = _this.mazeNodes[23][14].spritePos();
	  ...
	  _createClass(SnackMan, [{
	    ...
	    value: function reset() {
	      this.pos = this.mazeNodes[23][14].spritePos();
	      this.mouthOpen = true;
	      this.dir = "right";
	    }
	  }, {
	    ...
	    value: function draw(ctx) {
	      ...
	      switch (this.sym) {
	        ...
	        case ".":
	          ...
	          ctx.arc(x + spriteHeight, y + spriteHeight, 2, 0, 2 * Math.PI, true);
	          ctx.fill();
	          break;
	        case "O":
	          ctx.beginPath();
	          ...
	          ctx.fillStyle = "#cccccc";
	          ctx.arc(x + spriteHeight, y + spriteHeight, 7, 0, 2 * Math.PI, true);
	          ctx.fill();
	          break;
	        default:
	          console.log(':(');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g1 = function (_Ghost) {
	  ...
	  function g1(game) {
	    ...
	    _this.color = '#66846c';
	    _this.pos = _this.mazeNodes[12][14].spritePos();
	    return _this;
	  }
	  ...
	  _createClass(g1, [{
	    ...
	    key: 'reset',
	    value: function reset() {
	      this.pos = this.mazeNodes[12][14].spritePos();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g2 = function (_Ghost) {
	  ...
	  function g2(game) {
	    ...
	    _this.color = '#5b6887';
	    _this.pos = _this.mazeNodes[14][12].spritePos();
	    return _this;
	  }
	  ...
	  _createClass(g2, [{
	    ...
	    key: 'reset',
	    value: function reset() {
	      this.pos = this.mazeNodes[14][12].spritePos();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g3 = function (_Ghost) {
	  ...
	  function g3(game) {
	    ...
	    _this.color = '#846680';
	    _this.pos = _this.mazeNodes[14][14].spritePos();
	    return _this;
	  }
	  ...
	  _createClass(g3, [{
	    ...
	    key: 'reset',
	    value: function reset() {
	      this.pos = this.mazeNodes[14][14].spritePos();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g4 = function (_Ghost) {
	  ...
	  function g4(game) {
	    ...
	    _this.color = '#874e4d';
	    _this.pos = _this.mazeNodes[14][16].spritePos();
	    return _this;
	  }
