	...
	var Ghost = function (_MovingObject) {
	  ...
	  _createClass(Ghost, [{
	    ...
	    value: function potentialMoves(location) {
	      ...
	      return Util.nearbySqs(location).filter(function (sq) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g2 = function (_Ghost) {
	  ...
	  function g2(game) {
	    ...
	    _this.visitedPostions = _this.pos;
	    _this.dir = 'up';
	    return _this;
	  }
	  ...
	  _createClass(g2, [{
	    ...
	    value: function buildMoveTree() {
	      ...
	      if (nodes.length) {
	        ...
	        var newMoves = this.potentialMoves(this.location);
	        newMoves.forEach(function (newMove) {
	          var newNode = _this2.node(newMove);
	    ...
	    key: 'findPath',
	    value: function findPath(snackman) {}
	  }, {
	    key: 'tracePathBack',
	    value: function tracePathBack() {}
	  }, {
	    key: 'reset',
	    value: function reset() {
	      this.location = [10, 9];
...
/***/ function(module, exports) {
	...
	var nearbySqs = exports.nearbySqs = function nearbySqs(location) {
	  var row = location[0];
	  var col = location[1];
	
	  var maxRowIdx = undefined.mazs[0].length - 1;
