...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnackMan = function (_MovingObject) {
	  ...
	  _createClass(SnackMan, [{
	    ...
	    value: function move() {
	      this.checkDir();
	      var newLoc = Util.move(this.location, this.dir);
	    ...
	    value: function draw(ctx) {
	      ...
	      switch (this.sym) {
	        ...
	        case ".":
	          ...
	          if (!this.visited) {
	            ctx.fillStyle = "black";
	            ctx.fillRect(x + 7, y + 7, sqHeight - 12, sqHeight - 12);
	
	            // ctx.arc(x + spriteHeight, this.centerPos()[1], 5,
	            //   0, 2 * Math.PI, true);
...
/***/ function(module, exports) {
	...
	var move = exports.move = function move(location, direction) {
