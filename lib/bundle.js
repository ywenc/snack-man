...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnackMan = function (_MovingObject) {
	  ...
	  function SnackMan(game) {
	    ...
	    var _this = _possibleConstructorReturn(this, (SnackMan.__proto__ || Object.getPrototypeOf(SnackMan)).call(this, game, [23, 14]));
	
	    _this.color = '#000000';
	    _this.location = [23, 14];
	    _this.pos = _this.node([23, 14]).spriteStart();
	    _this.radius = game.spriteHeight - 2;
	  ...
	  _createClass(SnackMan, [{
	    ...
	    key: 'potentialMoves',
	    value: function potentialMoves() {
	      var _this2 = this;
	
	      return this.nearbySqs().filter(function (sq) {
	        return _this2.node(sq).snackPassageway();
	      });
	    }
	  }, {
	    key: 'changeDir',
	    value: function changeDir(dir) {
	      ...
	      var _location2 = _slicedToArray(this.location, 2),
	          row = _location2[0],
	          col = _location2[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g1 = function (_Ghost) {
	  ...
	  function g1(game) {
	    ...
	    var _this = _possibleConstructorReturn(this, (g1.__proto__ || Object.getPrototypeOf(g1)).call(this, game, [11, 14]));
	
	    _this.color = '#66846c';
	    _this.pos = _this.node([12, 14]).spriteStart();
	    _this.dir = "up";
	    return _this;
	  }
	  ...
	  _createClass(g1, [{
	    key: 'move',
	    value: function move() {
	      var randIdx = Math.floor(Math.random() * this.potentialMoves().length);
	      var randMove = this.potentialMoves()[randIdx];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g2 = function (_Ghost) {
	  ...
	  function g2(game) {
	    ...
	    var _this = _possibleConstructorReturn(this, (g2.__proto__ || Object.getPrototypeOf(g2)).call(this, game, [14, 12]));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g3 = function (_Ghost) {
	  ...
	  function g3(game) {
	    ...
	    var _this = _possibleConstructorReturn(this, (g3.__proto__ || Object.getPrototypeOf(g3)).call(this, game, [14, 14]));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g4 = function (_Ghost) {
	  ...
	  function g4(game) {
	    ...
	    var _this = _possibleConstructorReturn(this, (g4.__proto__ || Object.getPrototypeOf(g4)).call(this, game, [14, 16]));
