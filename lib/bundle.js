...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  function Game() {
	    ...
	    // this.ghosts = [].concat([new g4(this)]);//, new g1(this), new g3(this), new g4(this)]);
	  }
	...
	var MovingObject = function () {
	  ...
	  _createClass(MovingObject, [{
	    ...
	    value: function isTouching(obj) {
	      return this.location[0] === obj.location[0] && this.location[1] === obj.location[1];
	    }
	  }, {
	    key: 'nearbySqs',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g2 = function (_Ghost) {
	  ...
	  _createClass(g2, [{
	    key: 'leavePen',
	    value: function leavePen(ctx) {
	      var _this2 = this;
	
	      setTimeout(function () {
	        _this2.pos = [_this2.node([10, 9]).centerPos()[0], _this2.node([10, 9]).centerPos()[1] + 2];
	        _this2.game.draw(ctx);
	      }, 360);
	      setTimeout(function () {
	        _this2.pos = _this2.node([10, 10]).centerPos();
	        _this2.game.draw(ctx);
	      }, 480);
	      setTimeout(function () {
	        _this2.pos = [_this2.node([10, 10]).centerPos()[0], _this2.node([10, 10]).centerPos()[1] + 2];
	        _this2.game.draw(ctx);
	      }, 600);
	      setTimeout(function () {
	        _this2.pos = _this2.node([9, 10]).centerPos();
	        _this2.game.draw(ctx);
	      }, 720);
	      setTimeout(function () {
	        _this2.pos = [_this2.node([9, 10]).centerPos()[0], _this2.node([9, 10]).centerPos()[1] + 2];
	        _this2.game.draw(ctx);
	      }, 840);
	      setTimeout(function () {
	        _this2.pos = _this2.node([8, 10]).centerPos();
	        _this2.game.draw(ctx);
	        _this2.location = [8, 10];
	      }, 960);
	    }
	  }, {
	    key: 'move',
	...
	var g3 = function (_Ghost) {
	  ...
	  _createClass(g3, [{
	    ...
	    value: function leavePen(ctx) {
	      ...
	      setTimeout(function () {
	        _this2.pos = [_this2.node([8, 10]).centerPos()[0], _this2.node([8, 10]).centerPos()[1] + 2];
	        _this2.game.draw(ctx);
	        _this2.location = [8, 10];
	      }, 360);
	    }
	  ...
	  _createClass(g4, [{
	    ...
	    value: function move() {
	      ...
	      if (this.location[0] === 10 && this.location[1] === 11) {
	        ...
	        var tube = this.potentialMoves(this.location).length === 2 ? true : false;
	        var newLoc = Util.checkNewLoc(this.location, this.dir);
	    ...
	    value: function changeDir(dir) {
	      // debugger
	      var target = this.snackman.location;
	      var newDirs = void 0,
	          newDir = void 0,
	          possibleLoc = void 0,
	          randChange = void 0;
	  ...
	  _createClass(GameView, [{
	    ...
	    value: function countdown() {
	      ...
	      var id = setInterval(function () {
	        _this3.drawStatic();
	        _this3.dialog("game starting in " + Math.floor(_this3.timer));
	        _this3.timer -= 0.5;
	        if (_this3.timer <= 1) clearInterval(id);
	      }, 500);
	    }
	  }, {
	    key: "start",
	    value: function start() {
	      ...
	      setTimeout(function () {
	        _this4.game.resetLocs();
	        clearInterval(_this4.ticker);
	        _this4.ticker = setInterval(function () {
	          _this4.update();
	        }, 160);
	      }, 2500);
	    }
