...
/***/ function(module, exports, __webpack_require__) {
	...
	var g1 = function (_Ghost) {
	  ...
	  function g1(game) {
	    ...
	    _this.color = '#f79a7e';
	    _this.mapNode = _this.node(_this.location);
	    _this.pos = _this.mapNode.centerPos();
	    _this.dir = "up";
	    return _this;
	  }
	    ...
	    value: function changeDir(dir) {
	      ...
	      switch (dir) {
	        ...
	        case 'right':
	          ...
	          //looks random enough
	          var possibleLoc = Util.checkNewLoc(this.location, 'up');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g2 = function (_Ghost) {
	  ...
	  function g2(game) {
	    ...
	    _this.visitedPostions = [_this.mapNode];
	    _this.dir = 'right';
	    return _this;
	  }
	    ...
	    value: function changeDir(dir) {
	      ...
	      switch (dir) {
	        ...
	        case 'right':
	          ...
	          //this way, the ghost always goes up and left if it can
	          //looks random enough
	          var possibleLoc = Util.checkNewLoc(this.location, 'down');
	...
	var g4 = function (_Ghost) {
	  ...
	  _createClass(g4, [{
	    ...
	    value: function leavePen(ctx) {
	      ...
	      setTimeout(function () {
	        _this2.pos = _this2.node([10, 11]).centerPos();
	        _this2.game.draw(ctx);
	      }, 120);
	      setTimeout(function () {
	        _this2.pos = [_this2.node([10, 11]).centerPos()[0], _this2.node([10, 11]).centerPos()[1] + 2];
	        _this2.game.draw(ctx);
	      }, 240);
	      setTimeout(function () {
	        _this2.pos = _this2.node([10, 10]).centerPos();
	  ...
	  _createClass(GameView, [{
	    ...
	    value: function start() {
	      ...
	      this.game.ghosts.forEach(function (ghost) {
	        return ghost.leavePen(_this.ctx);
	      });
