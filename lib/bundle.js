...
/***/ function(module, exports, __webpack_require__) {
	...
	var _maze3 = __webpack_require__(20);
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function mapCenter() {
	      return this.lvlMap.mazeNodes[8][0].centerPos()[1];
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnackMan = function (_MovingObject) {
	  ...
	  function SnackMan(game) {
	    ...
	    _this.radius = game.spriteHeight - 5;
	...
	var MovingObject = function () {
	  ...
	  _createClass(MovingObject, [{
	    ...
	    value: function nearbySqs() {
	      ...
	      var maxRowIdx = this.mazeNodes.length - 1;
	      var maxColIdx = this.mazeNodes[0].length - 1;
	
	      return [[Math.min(row + 1, maxRowIdx), col], [row, Math.min(col + 1, maxColIdx)], [Math.max(row + 1, maxRowIdx), col], [row, Math.max(col - 1, maxColIdx)]];
	    }
	  }, {
	    key: 'wrap',
	    value: function wrap() {
	    ...
	    value: function draw(ctx) {
	      ...
	      switch (this.sym) {
	        ...
	        case ".":
	          ...
	          ctx.arc(x + spriteHeight, this.centerPos()[1], 2, 0, 2 * Math.PI, true);
	          ctx.fill();
	          break;
	        case "O":
	          ctx.beginPath();
	          ...
	          ctx.fillStyle = "#cccccc";
	          ctx.arc(x + spriteHeight, this.centerPos()[1], 7, 0, 2 * Math.PI, true);
	          ctx.fill();
	          break;
	        default:
	          console.log(':(');
...
/***/ function(module, exports) {
	...
	var Maze1 = ["=====================", "=.........=.........=", "=O===.===.=.===.===O=", "=.===.===.=.===.===.=", "=...................=", "=.===.=.=====.=.===.=", "=.....=...=...=.....=", "=====.===.=.===.=====", "xxxx=.=.......=.=xxxx", "=====.=.==pP=.=.=====", "........=QQQ=........", "=====.=.=====.=.=====", "xxxx=.=.......=.=xxxx", "=====.=.=====.=.=====", "=.........=.........=", "=.===.===.=.===.===.=", "=O..=...........=..O=", "===.=.=.=====.=.=.===", "=.....=...=...=.....=", "=.=======.=.=======.=", "=...................=", "====================="];
