...
/***/ function(module, exports) {
	...
	var mazeNode = function () {
	  function mazeNode(pos, startCoords, sym, spriteHeight) {
	  ...
	  _createClass(mazeNode, [{
	    ...
	    key: "centerPt",
	    value: function centerPt() {
	      var x = this.startCoords[0];
	      var y = this.startCoords[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g1 = function (_Ghost) {
	  ...
	  function g1(game) {
	    ...
	    _this.color = '#66846c';
	    _this.pos = [game.dimX / 2, game.dimY / 2 - _this.radius * 2.5];
	    return _this;
	  }
